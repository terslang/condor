...
public:
    ...
    static PairwiseContest create(int electionId, const QString &optionAId, const QString &optionBId, int optionACount, int optionBCount);
...
private:
    ...
    friend T_MODEL_EXPORT QDataStream &operator<<(QDataStream &ds, const PairwiseContest &model);
    friend T_MODEL_EXPORT QDataStream &operator>>(QDataStream &ds, PairwiseContest &model);
};

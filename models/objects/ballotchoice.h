...
public:
    ...
    static BallotChoice create(const QString &ballotId, const QString &optionId, int rank);
    static BallotChoice create(const QVariantMap &values);
    static BallotChoice update(const QString &ballotId, const QString &optionId, int rank);
...
private:
    ...
    friend T_MODEL_EXPORT QDataStream &operator<<(QDataStream &ds, const BallotChoice &model);
    friend T_MODEL_EXPORT QDataStream &operator>>(QDataStream &ds, BallotChoice &model);
};

...
QString
BallotChoice::ballotId() const
{
  return d->ballot_id;
}

void
BallotChoice::setBallotId(const QString& ballotId)
{
  d->ballot_id = ballotId;
}

QString
BallotChoice::optionId() const
{
  return d->option_id;
}

void
BallotChoice::setOptionId(const QString& optionId)
{
  d->option_id = optionId;
}

int
BallotChoice::rank() const
{
  return d->rank;
}

void
BallotChoice::setRank(int rank)
{
  d->rank = rank;
}
...
BallotChoice
BallotChoice::create(const QString& ballotId, const QString& optionId, int rank)
{
...
BallotChoice
BallotChoice::create(const QVariantMap& values)
{
  BallotChoice model;
...
BallotChoice
BallotChoice::update(const QString& ballotId, const QString& optionId, int rank)
{
  BallotChoiceObject obj;
  obj.ballot_id = ballotId;
  obj.option_id = optionId;
...
BallotChoice
BallotChoice::get(const QString& ballotId)
{
...
int
BallotChoice::getOutrankingCount(const QString& optionAId,
...
BallotChoice::getAll()
{
  return tfGetModelListByCriteria<BallotChoice, BallotChoiceObject>(
    TCriteria());
}

QJsonArray
BallotChoice::getAllJson(const QStringList& properties)
{
  return tfConvertToJsonArray(getAll(), properties);
}

QList<BallotChoice>
BallotChoice::getByBallotId(const QString& ballotId)
{
...
TModelObject*
BallotChoice::modelData()
{
  return d.data();
}

const TModelObject*
BallotChoice::modelData() const
{
  return d.data();
}

QDataStream&
operator<<(QDataStream& ds, const BallotChoice& model)
{
...
QDataStream&
operator>>(QDataStream& ds, BallotChoice& model)
{
  QVariantMap varmap;
  ds >> varmap;

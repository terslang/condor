...
int
PairwiseContest::electionId() const
{
  return d->election_id;
}

QString
PairwiseContest::optionAId() const
{
  return d->option_a_id;
}

void
PairwiseContest::setOptionAId(const QString& optionAId)
{
  d->option_a_id = optionAId;
}

QString
PairwiseContest::optionBId() const
{
  return d->option_b_id;
}

void
PairwiseContest::setOptionBId(const QString& optionBId)
{
  d->option_b_id = optionBId;
}

int
PairwiseContest::optionACount() const
{
  return d->option_a_count;
}

void
PairwiseContest::setOptionACount(int optionACount)
{
  d->option_a_count = optionACount;
}

int
PairwiseContest::optionBCount() const
{
  return d->option_b_count;
}

void
PairwiseContest::setOptionBCount(int optionBCount)
{
...
PairwiseContest
PairwiseContest::create(int electionId,
...
PairwiseContest
PairwiseContest::create(const QVariantMap& values)
{
...
QList<PairwiseContest>
PairwiseContest::get(int electionId)
{
  return tfGetModelListByCriteria<PairwiseContest, PairwiseContestObject>(
    TCriteria(PairwiseContestObject::ElectionId, electionId));
}

int
PairwiseContest::count()
{
...
QJsonArray
PairwiseContest::getAllJson(const QStringList& properties)
{
  return tfConvertToJsonArray(getAll(), properties);
}

TModelObject*
PairwiseContest::modelData()
{
  return d.data();
}

const TModelObject*
PairwiseContest::modelData() const
{
  return d.data();
}

QDataStream&
operator<<(QDataStream& ds, const PairwiseContest& model)
{
...
QDataStream&
operator>>(QDataStream& ds, PairwiseContest& model)
{
  QVariantMap varmap;
  ds >> varmap;

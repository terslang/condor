...
void OptionService::index()
{
    auto optionList = Option::getAll();
    texport(optionList);
}

void OptionService::show(const QString &id)
{
...
void OptionService::edit(TSession& session, const QString &id)
{
...
int OptionService::save(THttpRequest &request, TSession &session, const QString &id)
{
    auto model = Option::get(id);
...
bool OptionService::remove(const QString &id)
{
    auto option = Option::get(id);

...
void ElectionService::edit(TSession& session, int id)
{
...
int ElectionService::save(THttpRequest &request, TSession &session, int id)
{
    auto model = Election::get(id);
...
bool ElectionService::remove(int id)
{
    auto election = Election::get(id);

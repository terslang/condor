...
void
UserService::show(const QString& email)
{
...
QString
UserService::create(THttpRequest& request)
{
...
void
UserService::edit(TSession& session, const QString& email)
{
...
int
UserService::save(THttpRequest& request,
                  TSession& session,
                  const QString& email)
{
  auto model = User::get(email);
...
bool
UserService::remove(const QString& email)
{
  auto user = User::get(email);
  return user.remove();
}

...
void
PairwiseContestService::show(int electionId)
{
...
int
PairwiseContestService::create(int electionId,
                               ...
                               const QString& optionBId)
{
  ...
  auto model = PairwiseContest::create(
    electionId, optionAId, optionBId, optionACount, optionBCount);
...
void
PairwiseContestService::edit(TSession& session, int electionId)
{
  // not implemented yet
}

int
PairwiseContestService::save(THttpRequest& request,
                             TSession& session,
                             int electionId)
{
  // not implemented yet
...
bool
PairwiseContestService::remove(int electionId)
{
  // not implemented yet
}

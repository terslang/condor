...
void ElectionController::show(const QString &id)
{
    service.show(id.toInt());
    render();
}

void ElectionController::create()
{
    int id;
...
void ElectionController::save(const QString &id)
{
    int res;
...
void ElectionController::remove(const QString &id)
{
    switch (request().method()) {
    case Tf::Post:
